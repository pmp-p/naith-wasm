...
class DeveloperConsole(InteractiveInterpreter, DirectObject):
    ...
    def __init__(self, manager, xml):
        ...
        font = loader.loadFont("data/cmss12.ttf")
        ...
        self.otext = OnscreenText(
            parent=self.entry, scale=1, align=TextNode.ALeft, pos=(1, 0, 0), fg=(1, 1, 0.5, 1), text=":", font=font
        )
        self.lines = [""] * 9
    ...
    def command(self, text):
        if not self.hidden:
            ...
            for plugin in list(self.manager.named.keys()):
